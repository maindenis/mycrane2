...
function getTagsListParams() {
  if($(".tags_wrapp").length > 0) {
    rows = 2;
    parent = $(".tags_wrapp");
    btn = parent.find(".dr_btn");
    list = parent.find(".list_wrapp_dr");
    listHeightConst = $(".tags_list_yellow").outerHeight();
    tagHeight = list.find("li").outerHeight();
    if(listHeightConst <= tagHeight * rows) {
...
$(document).ready(function() {
    ...
    $(".dr_btn").on('click',function (e) {
      e.preventDefault();
      parent = $(this).closest(".tags_wrapp");
      dr = parent.find(".list_wrapp_dr");
      listHeight = parent.find(".tags_list_yellow").height();
      lessHeight = parent.find(".tags_list_yellow li").outerHeight() * 2
    ...
    if( $(".mr_slider").length > 0 ) {
      $(".mr_slider").not(".slick-initialized").slick({
          dots: true,
          arrows: true,
          // autoplay: true,
          // autoplaySpeed: 4000,
